...
public class WorkoutList {
    ...
    private void initWorkoutList() {
        ...
        workouts.add(new Workout(context, R.string.pushups, R.string.pushups_description, R.drawable.pushups));
        workouts.add(new Workout(context, R.string.pullups, R.string.pullups_description, R.drawable.pullups));
